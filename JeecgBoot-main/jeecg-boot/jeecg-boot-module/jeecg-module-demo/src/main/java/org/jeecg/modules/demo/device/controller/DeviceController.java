...
public class DeviceController extends JeecgController<Device, IDeviceService> {
	...
	@Operation(summary="设备管理-批量删除")
	@RequiresPermissions("device:device:deleteBatch")
    ...
    * @param device
    */
    @RequiresPermissions("device:device:exportXls")
    @RequestMapping(value = "/exportXls")
    public ModelAndView exportXls(HttpServletRequest request, Device device) {
        return super.exportXls(request, device, Device.class, "设备管理");
    }
    ...
    * @return
    */
    @RequiresPermissions("device:device:importExcel")
