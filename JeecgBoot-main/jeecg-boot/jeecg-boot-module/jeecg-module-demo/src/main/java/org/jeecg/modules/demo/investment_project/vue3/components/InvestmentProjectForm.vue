...
<script lang="ts">
    ...
    import {getBpmFormSchema} from '../InvestmentProject.data';
    import {saveOrUpdate} from '../InvestmentProject.api';
    ...
    export default defineComponent({
        ...
        setup(props){
            ...
            let formData = {};
            const queryByIdUrl = '/investment_project/investmentProject/queryById';
